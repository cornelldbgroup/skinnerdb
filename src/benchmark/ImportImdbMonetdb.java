...
public class ImportImdbMonetdb {
    ...
    private void importTable(String dataFolder, String tableName) throws Exception {
        ...
        while ((attributes = reader.readNext()) != null) {
            ...
            for (int i = 0; i < attributes.length; i++) {
                ...
                if(insertTuple[i] != null) {
                    insertTuple[i] = insertTuple[i].replaceAll("'","\'");
                    insertTuple[i] = insertTuple[i].replaceAll("\"","\\\"");
                }
            }
    ...
    private void importDatabase(String dataFolder) throws Exception {
        String[] tableNames = {"person_info","title","char_name"};
        /*
    ...
    public static void main(String[] argv) throws Exception {
        ...
        ImportImdbMonetdb importImdbMonetdb = new ImportImdbMonetdb("imdbxxl");
        importImdbMonetdb.importDatabase("/home/jw2544/Monetdb/xxl/");
    }
}