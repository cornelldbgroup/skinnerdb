...
public class OldPreprocessor {
    ...
    static ExpressionInfo applyIndex(QueryInfo query, ExpressionInfo unaryPred,
        ...
        OldIndexTest indexTest = new OldIndexTest(query);
        ...
        if (!indexedConjuncts.isEmpty()) {
            OldIndexFilter indexFilter = new OldIndexFilter(query);
            ...
            Materialize.executeOld(table, requiredCols, rows,
    ...
    static void createJoinIndices(QueryInfo query, Context preSummary)
        ...
        query.indexCols.parallelStream().forEach(queryRef -> {
            try {
                ...
                Indexer.partitionIndex(dbRef, queryRef, null, false, true, false);
            } catch (Exception e) {
