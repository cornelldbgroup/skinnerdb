...
//                int[] joinOrder = new int[query.nrJoined];
//                //if (i > 0) {
//                    CommonQueryPrefix commonQueryPrefix = query.findShortOrders(0, orderList, triedQuery);
//                    if (commonQueryPrefix != null) {
//                        int reusedQuery = commonQueryPrefix.reusedQuery;
//                        if (batchGroups[reusedQuery] == null)
//                            batchGroups[reusedQuery] = new HashMap<>();
...
//            for (int i = 0; i < nrQueries; i++) {
//                HashMap<Integer, List<Integer>> batchM = batchGroups[i];
//                if(batchM == null)
//                    continue;
//                System.out.println("##################################");
//                System.out.println("reuse group for query " + i);
//                System.out.println("order: " + Arrays.toString(orderList[i]));
//
//                batchM.forEach((k , l) -> l.forEach(m -> System.out.println("query: "+ m + ", order: " + Arrays.toString(orderList[m]))));
//                System.out.println("##################################");
//            }
...
//            double[] reward = batchQueryJoin.execute(orderList, batchGroups, 0);
//            for (int i = 0; i < nrQueries; i++) {
//                if(GlobalContext.queryStatus[i])
//                    continue;
