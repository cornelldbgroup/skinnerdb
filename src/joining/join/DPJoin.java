...
public abstract class DPJoin {
     ...
     * @throws Exception
     */
    public DPJoin(QueryInfo query) throws Exception {
        this.query = query;
     ...
     */
    public DPJoin(QueryInfo query, Context preSummary, int nrThreads) throws Exception {
        this.query = query;
        this.nrJoined = query.nrJoined;
     ...
     * @throws Exception
     */
    public abstract double execute(int[] order, int tid) throws Exception;
    /**
