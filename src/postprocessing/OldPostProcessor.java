...
public class OldPostProcessor {
    ...
    static void treatGroupAggQuery(QueryInfo query,
        ...
        if (hasHaving) {
            ...
            Materialize.executeOld(NamingConfig.RESULT_NO_HAVING,
            ...
            if (hasOrder) {
                ...
                Materialize.executeOld(NamingConfig.ORDER_NO_HAVING,
    ...
    public static void process(QueryInfo query, Context context,
        ...
        if (hasLimit) {
            ...
            operators.Materialize.executeOld(preLimitResult,
